...
function AdvancedStabilizersSection() {
  ...
  return (
    <section
      id="advanced-stabilizers"
      ref={sectionRef}
      className="w-full min-h-[500px] bg-bg_light_blue"
    >
      <h2 className="text-[36px] font-semibold pl-[24px] pt-[32px] font-inter">Advanced Stabilizers</h2>
      <div className="w-full flex flex-wrap gap-4 px-4 py-4 justify-center items-stretch">
        ...
        {!isMobile && selectedIdx !== null && (
          <ExpandedProductCard
            {...AdvancedStabilizers[selectedIdx]}
            onClose={() => setSelectedIdx(null)}
          />
        )}
        {AdvancedStabilizers.map((item, idx) => {
...
export default AdvancedStabilizersSection; 