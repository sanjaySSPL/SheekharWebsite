          ...
          >
            ...
            <div className="flex flex-col gap-8 items-center w-full">
              ...
              <div className="text-lg font-semibold text-gray-800 flex flex-col items-center">
                <span>Call us:</span>
                <a href="tel:+91 7397950657" className="text-2xl text-blue-700 underline mt-1">+91 12345 67890</a>
              </div>
              {/* Download Brochure */}
              <a
                href="/brochure.pdf" // Replace with actual path
                download
                className="bg-white text-red-700 font-semibold px-6 py-3 rounded shadow hover:bg-gray-100 transition"
              >
                Download Brochure
              </a>
              {/* WhatsApp Button */}
