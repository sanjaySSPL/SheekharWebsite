  ...
  return (
    ...
    <div className='h-[284px] w-[100dvw] pt-[20px] md:pt-0 mt-[20px] md:mt-[56px] md:ml-[55px]'>
        ...
        <div className="md:w-[91%]  md:p-0 p-4 text-[20px]  text-text_blue">
                         <p className='mb-10'> At Neyohm, ethics and loyalty form the foundation of our identity. We are committed to producing all our offerings using non-animal-derived ingredients, ensuring that exceptional recipes can be created with compassion. Each ingredient is responsibly sourced and processed with care, reflecting our dedication to cruelty-free, transparent, and sustainable practices that respect both people and the planet. This ethos extends to our partnerships — we work with honesty, support you at every step, and adapt to your specific needs. With Neyohm, you gain a reliable partner who shares your values and vision.</p>
                <br/>
