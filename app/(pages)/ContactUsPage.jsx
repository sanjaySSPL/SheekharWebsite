...
function ContactUsPage() {
  return (
    ...
    >
        <h2 className="md:text-[36px] sm:text-[32px]  font-semibold text-[36px] text-start md:ml-36 md:font-semibold text-text_blue font-inter italic mx-10 md:mt-[65px] mt-[50px] mb-[50px] md:mb-[40px] ">Get your solution customized </h2>
