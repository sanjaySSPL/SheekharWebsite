...
function ChooseSheekharIngredient() {
  ...
  const items = [
    ...
    },
    {
      ...
      alt: 'Stronger Consumer Response',
      x: isMobile ? 60 : 500,
      y: isMobile ? 160 : 500,
    },
    {
        ...
        <div className="relative h-full w-full">
          {items.map((item, idx) => (
            ...
            >
              ...
              />
              <p className="text-center mt-2 text-[12px] md:text-text_blue md:text-[20px] ">{item.alt}</p>
            </motion.div>
          ))}
        </div>
      </div>

      <div className="w-full md:w-[688px] absolute z-20 top-1/2 -translate-y-1/2 md:left-1/2 md:top-1/2 md:-translate-y-1/2 transform md:-translate-x-1/2">
